...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Nitronorte | Urea agrícola 46%" },
      { name: "description", content: "Nitronorte distribuye urea agrícola 46% N al granel y en sacos de 50 kg para palma, arroz, maíz, café, caña, banano y ganadería en Colombia." },
      { name: "author", content: "Nitronorte" },
      { property: "og:title", content: "Nitronorte | Urea agrícola 46%" },
      { property: "og:description", content: "Nitronorte distribuye urea agrícola 46% N al granel y en sacos de 50 kg para palma, arroz, maíz, café, caña, banano y ganadería en Colombia." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Nitronorte" },
      { name: "twitter:title", content: "Nitronorte | Urea agrícola 46%" },
      { name: "twitter:description", content: "Nitronorte distribuye urea agrícola 46% N al granel y en sacos de 50 kg para palma, arroz, maíz, café, caña, banano y ganadería en Colombia." },
